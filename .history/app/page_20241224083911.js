...
export default function Home() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const historicalUrl = `${process.env.NEXT_PUBLIC_HISTORICAL_API_URL.replace(
        "{lat}",
        lat
      )
        .replace("{lon}", lon)
      ...
      console.log("Historical Data Response:", historicalResponse.data); // Log historical data
